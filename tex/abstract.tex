...
Additionally, blockchain technology has the potential to transform data management in both medical and \ac{iot} applications, with the need for innovative data marketplaces becoming increasingly apparent for safe and efficient data exchange.
...
This paper reviews blockchain-based medical and \ac{iot} research that addresses trading issues and provides a comprehensive comparison between them.
